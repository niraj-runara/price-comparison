#!/usr/bin/env python3
"""Plot unified RTX vs unified L4 benchmark comparison from combined_results.json."""
import argparse
import json
import os
...
def main():
    ...
    plot_metric(df, "cost_per_1m_tokens_usd", "USD per 1M tokens", "Cost per 1M tokens: Unified RTX vs Unified L4",
