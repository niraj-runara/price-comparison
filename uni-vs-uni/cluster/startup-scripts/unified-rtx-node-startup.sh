#!/usr/bin/env bash
# ==============================================================================
# Setup script for `unified-rtx-node` — baseline.
...
[Unit]
Description=SGLang unified server (1x RTX PRO 6000)
...
echo "unified-rtx-node startup script complete."
